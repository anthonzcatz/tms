              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../dashboard/project-management.html">
                  ...
                  <div class="row g-3 justify-content-between">
                    ...
                    <div class="col-auto ps-0">
                      <div class="avatar-group avatar-group-dense">
                        ...
                        <div class="avatar avatar-xl border border-3 border-200 rounded-circle">
                          <img class="rounded-circle" src="<?php echo BASE_URL; ?>/resources/assets/img/team/2-thumb.png" alt="" />
              ...
              <div class="card h-100">
                ...
                <div class="card-body pt-0">
                  ...
                  <div class="avatar-group avatar-group-dense mb-3">
                    ...
                    <div class="avatar avatar-2xl border border-3 border-200 rounded-circle">
                      <img class="rounded-circle" src="<?php echo BASE_URL; ?>/resources/assets/img/team/4-thumb.png" alt="" />

                    </div>
                    <div class="avatar avatar-2xl border border-3 border-200 rounded-circle">
                      <img class="rounded-circle" src="<?php echo BASE_URL; ?>/resources/assets/img/team/5-thumb.png" alt="" />
              ...
              <div class="card h-100">
                ...
                <div class="card-body members-activity scrollbar-overlay">
                  <div class="row g-2 mb-4">
                    ...
                    <div class="col-4 position-relative"><img class="w-100" src="<?php echo BASE_URL; ?>/resources/assets/img/management/activity-1.png" alt="..." />
                      <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-danger">20%</div>
                    </div>
                    <div class="col-4 position-relative"><img class="w-100" src="<?php echo BASE_URL; ?>/resources/assets/img/management/activity-2.png" alt="..." />
                      <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-primary">67%</div>
                    </div>
                    <div class="col-4 position-relative"><img class="w-100" src="<?php echo BASE_URL; ?>/resources/assets/img/management/activity-3.png" alt="..." />
                  ...
                  <div class="row g-2 mb-4">
                    ...
                    <div class="col-4 position-relative"><img class="w-100" src="<?php echo BASE_URL; ?>/resources/assets/img/management/activity-4.png" alt="..." />
                      <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-success">20%</div>
                    </div>
                    <div class="col-4 position-relative"><img class="w-100" src="<?php echo BASE_URL; ?>/resources/assets/img/management/activity-5.png" alt="..." />
                      <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-danger">67%</div>
                    </div>
                    <div class="col-4 position-relative"><img class="w-100" src="<?php echo BASE_URL; ?>/resources/assets/img/management/activity-6.png" alt="..." />
                  ...
                  <div class="row g-2 mb-4">
                    <div class="col-12 d-flex align-items-center">
                      <div class="avatar avatar-xl rounded-circle">
                        <img class="rounded-circle" src="<?php echo BASE_URL; ?>/resources/assets/img/team/16.jpg" alt="" />

                      </div>
                      <h6 class="mb-0 ps-2">Monica Geller</h6>
                    </div>
                    <div class="col-4 position-relative"><img class="w-100" src="<?php echo BASE_URL; ?>/resources/assets/img/management/activity-7.png" alt="..." />
                      <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-danger">20%</div>
                    </div>
                    <div class="col-4 position-relative"><img class="w-100" src="<?php echo BASE_URL; ?>/resources/assets/img/management/activity-8.png" alt="..." />
                      <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-success">67%</div>
                    </div>
                    <div class="col-4 position-relative"><img class="w-100" src="<?php echo BASE_URL; ?>/resources/assets/img/management/activity-9.png" alt="..." />
                      <div class="badge rounded-pill position-absolute top-100 start-50 translate-middle badge-subtle-primary">89%</div>
                    </div>
                  </div>
                </div>
                      ...
                      <tbody>
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative">
                              <div class="avatar avatar-2xl status-online">
                                <img class="rounded-circle" src="<?php echo BASE_URL; ?>/resources/assets/img/team/9.jpg" alt="" />
                          ...
                          <td>
                            <div class="d-flex align-items-center position-relative">
                              <div class="avatar avatar-2xl status-away">
                                <img class="rounded-circle" src="<?php echo BASE_URL; ?>/resources/assets/img/team/12.jpg" alt="" />
                        ...
                        <tr class="border-bottom border-200">
                          <td>
                            <div class="d-flex align-items-center position-relative">
                              <div class="avatar avatar-2xl status-online">
                                <img class="rounded-circle" src="<?php echo BASE_URL; ?>/resources/assets/img/team/avatar.png" alt="" />
                        ...
                        <tr>
                          <td>
                            <div class="d-flex align-items-center position-relative">
                              <div class="avatar avatar-2xl status-online">
                                <img class="rounded-circle" src="<?php echo BASE_URL; ?>/resources/assets/img/team/25.jpg" alt="" />
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="avatar-group justify-content-end">
                              ...
                              <div class="avatar avatar-xl border border-3 border-200 rounded-circle">
                                <img class="rounded-circle" src="<?php echo BASE_URL; ?>/resources/assets/img/team/13.jpg" alt="" />
                        ...
                        <tr>
                          ...
                          <td>
                            <div class="avatar-group justify-content-end">
                              ...
                              <div class="avatar avatar-xl border border-3 border-200 rounded-circle">
                                <img class="rounded-circle" src="<?php echo BASE_URL; ?>/resources/assets/img/team/18.jpg" alt="" />
