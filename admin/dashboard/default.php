...
<?php if (!defined('BASE_URL')) define('BASE_URL', '/TMS'); ?>
...
<html data-bs-theme="light" lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <meta name="msapplication-TileImage" content="<?php echo BASE_URL; ?>/resources/assets/img/favicons/mstile-150x150.png">
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="<?php echo BASE_URL; ?>/resources/vendors/prism/prism-okaidia.css" rel="stylesheet">
      ...
      <div class="container" data-layout="container">
        ...
        <nav class="navbar navbar-light navbar-vertical navbar-expand-xl">
          ...
          <div class="d-flex align-items-center">
            ...
            </div><a class="navbar-brand" href="<?php echo BASE_URL; ?>/admin/dashboard/default.php">
              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                  ...
                  <ul class="nav collapse" id="dashboard">
                    <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/admin/dashboard/default.php">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Default</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/public/dashboard/analytics.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Analytics</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/public/dashboard/crm.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">CRM</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/public/dashboard/e-commerce.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">E commerce</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/public/dashboard/lms.html">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/public/dashboard/project-management.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">Management</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/public/dashboard/saas.html">
                        <div class="d-flex align-items-center"><span class="nav-link-text ps-1">SaaS</span>
                        </div>
                      </a>
                      <!-- more inner pages-->
                    </li>
                    <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/public/dashboard/support-desk.html">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse" id="authentication">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/#authentication-modal" data-bs-toggle="modal">
                  ...
                  <ul class="nav collapse" id="user">
                    <li class="nav-item"><a class="nav-link" href="<?php echo BASE_URL; ?>/public/pages/user/profile.html">
                ...
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="forms">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="<?php echo BASE_URL; ?>/public/modules/forms/validation.html">
        ...
        <div class="content">
          <nav class="navbar navbar-light navbar-glass navbar-top navbar-expand">
            ...
            <a class="navbar-brand me-1 me-sm-3" href="<?php echo BASE_URL; ?>/admin/dashboard/default.php">
          ...
          <div class="card mb-3">
            <div class="bg-holder d-none d-lg-block bg-card" style="background-image:url(<?php echo BASE_URL; ?>/resources/assets/img/icons/spot-illustrations/corner-4.png);">
            </div>
            <!--/.bg-holder-->
          ...
          <div class="card mb-3">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-a268caaa-027e-41d9-9616-60e1a47f561a" type="button" role="tab" aria-controls="dom-a268caaa-027e-41d9-9616-60e1a47f561a" aria-selected="true" id="tab-dom-a268caaa-027e-41d9-9616-60e1a47f561a">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-29cace51-f3a3-4d7f-a614-eb35bf5c8c25" type="button" role="tab" aria-controls="dom-29cace51-f3a3-4d7f-a614-eb35bf5c8c25" aria-selected="false" id="tab-dom-29cace51-f3a3-4d7f-a614-eb35bf5c8c25">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-body-tertiary">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-a268caaa-027e-41d9-9616-60e1a47f561a" id="dom-a268caaa-027e-41d9-9616-60e1a47f561a">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-29cace51-f3a3-4d7f-a614-eb35bf5c8c25" id="dom-29cace51-f3a3-4d7f-a614-eb35bf5c8c25">
...
&lt;/form&gt;</code></pre>
          ...
          <div class="card">
              ...
              <div class="row flex-between-end">
                ...
                <div class="col-auto ms-auto">
                  <div class="nav nav-pills nav-pills-falcon flex-grow-1 mt-2" role="tablist">
                    <button class="btn btn-sm active" data-bs-toggle="pill" data-bs-target="#dom-126f9114-d495-43b3-b1c5-b6fab7e0d392" type="button" role="tab" aria-controls="dom-126f9114-d495-43b3-b1c5-b6fab7e0d392" aria-selected="true" id="tab-dom-126f9114-d495-43b3-b1c5-b6fab7e0d392">Preview</button>
                    <button class="btn btn-sm" data-bs-toggle="pill" data-bs-target="#dom-61f53bee-ffd7-4a67-b8f5-9695662365bb" type="button" role="tab" aria-controls="dom-61f53bee-ffd7-4a67-b8f5-9695662365bb" aria-selected="false" id="tab-dom-61f53bee-ffd7-4a67-b8f5-9695662365bb">Code</button>
                  </div>
                </div>
              </div>
            </div>
            <div class="card-body bg-body-tertiary">
              <div class="tab-content">
                <div class="tab-pane preview-tab-pane active" role="tabpanel" aria-labelledby="tab-dom-126f9114-d495-43b3-b1c5-b6fab7e0d392" id="dom-126f9114-d495-43b3-b1c5-b6fab7e0d392">
                  <form class="row g-3 needs-validation" novalidate="">
                ...
                <div class="tab-pane code-tab-pane" role="tabpanel" aria-labelledby="tab-dom-61f53bee-ffd7-4a67-b8f5-9695662365bb" id="dom-61f53bee-ffd7-4a67-b8f5-9695662365bb">
                  <pre class="scrollbar rounded-1" style="max-height:420px"><code class="language-html">&lt;form class=&quot;row g-3 needs-validation&quot; novalidate=&quot;&quot;&gt;
  &lt;div class=&quot;col-md-4 position-relative&quot;&gt;
    &lt;label class=&quot;form-label&quot; for=&quot;validationTooltip01&quot;&gt;First name&lt;/label&gt;
    &lt;input class=&quot;form-control&quot; id=&quot;validationTooltip01&quot; type=&quot;text&quot; value=&quot;Mark&quot; required=&quot;&quot; /&gt;
...
&lt;/form&gt;</code></pre>
    ...
    <script src="<?php echo BASE_URL; ?>/resources/vendors/prism/prism.js"></script>
