              ...
              <ul class="navbar-nav flex-column mb-3" id="navbarVerticalNav">
                <li class="nav-item">
                  ...
                  <ul class="nav collapse show" id="dashboard">
                    ...
                    <li class="nav-item"><a class="nav-link active" href="../dashboard/support-desk.html">
              ...
              <div class="row g-0 h-100">
                <div class="col-12 mb-3">
                  <div class="card bg-body-tertiary dark__bg-opacity-50 shadow-none">
                    <div class="bg-holder bg-card d-none d-sm-block" style="background-image:url(<?php echo BASE_URL; ?>/resources/assets/img/illustrations/ticket-bg.png);">
                    </div>
                    <!--/.bg-holder-->

                    <div class="d-flex align-items-center z-1 p-0"><img src="<?php echo BASE_URL; ?>/resources/assets/img/illustrations/ticket-welcome.png" alt="" width="96" />
                      <div class="ms-n3">
                    ...
                    <div class="card-body">
                      <div class="row g-0">
                        <div class="col-md-6 border-200 border-bottom border-end-md pb-x1 pe-md-x1">
                          <div class="row g-0">
                            <div class="col-6"><img class="mt-1" src="<?php echo BASE_URL; ?>/resources/assets/img/tickets/hold-tickets.png" alt="" width="39" />
                        ...
                        <div class="col-md-6 ps-md-x1 pb-x1 pt-x1 pt-md-0 border-bottom border-200">
                          <div class="row g-0">
                            <div class="col-6"><img class="mt-1" src="<?php echo BASE_URL; ?>/resources/assets/img/tickets/open-tickets.png" alt="" width="39" />
                        ...
                        <div class="col-md-6 border-200 border-bottom border-bottom-md-0 border-end-md pt-x1 pe-md-x1 pb-x1 pb-md-0">
                          <div class="row g-0">
                            <div class="col-6"><img class="mt-1" src="<?php echo BASE_URL; ?>/resources/assets/img/tickets/due-tickets.png" alt="" width="39" />
                        ...
                        <div class="col-md-6 ps-md-x1 pt-x1">
                          <div class="row g-0">
                            <div class="col-6"><img class="mt-1" src="<?php echo BASE_URL; ?>/resources/assets/img/tickets/unassigned.png" alt="" width="39" />
              ...
              <div class="card h-100">
                <div class="card-header d-flex flex-between-center border-bottom border-200 py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-unresolved-tickets" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs-11"></span></button>
                ...
                <div class="card-footer text-center border-top border-200 p-0"><a class="btn btn-link btn-sm px-0 fw-medium py-2" href="#!">View all<span class="fas fa-chevron-right ms-1 fs-11"></span></a></div>
              </div>
            </div>
          </div>
          <div class="row g-3">
              ...
              <div class="card h-100">
                  ...
                  <div class="row g-md-0">
                    <div class="col-auto d-md-flex">
                      <div class="d-flex align-items-center me-md-3 form-check mb-0">
                        ...
                        <label class="form-check-label lh-base mb-0 fs-11 text-500 fw-semi-bold font-base cursor-pointer" for="onHoldTickets">On Hold Tickets</label>
                      </div>
                      <div class="d-flex align-items-center me-md-3 form-check mb-0 mt-n1 mt-md-0">
                        ...
                        <label class="form-check-label lh-base mb-0 fs-11 text-500 fw-semi-bold font-base cursor-pointer" for="openTickets">Open Tickets</label>
                      </div>
                    </div>
                    <div class="col-auto d-md-flex">
                      <div class="d-flex align-items-center me-md-3 form-check mb-0">
                        ...
                        <label class="form-check-label lh-base mb-0 fs-11 text-500 fw-semi-bold font-base cursor-pointer" for="dueTickets">Due Tickets</label>
                      </div>
                      <div class="d-flex align-items-center form-check mb-0 mt-n1 mt-md-0">
                        ...
                        <label class="form-check-label lh-base mb-0 fs-11 text-500 fw-semi-bold font-base cursor-pointer" for="unassignedTickets">Unassigned Tickets</label>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-footer bg-body-tertiary py-2">
                  <div class="row g-2 flex-between-center">
                    ...
                    <div class="col-auto"><a class="btn btn-link btn-sm px-0" href="#!">View all reports<span class="fas fa-chevron-right ms-1 fs-11"></span></a></div>
                  </div>
                </div>
              </div>
            </div>
            <div class="col-xxl-4 col-md-6">
              <div class="card h-100">
                <div class="card-header d-flex flex-between-center border-bottom border-200 py-2">
                  ...
                  <div class="dropdown font-sans-serif btn-reveal-trigger">
                    <button class="btn btn-link text-600 btn-sm dropdown-toggle dropdown-caret-none btn-reveal" type="button" id="dropdown-customer-satisfaction" data-bs-toggle="dropdown" data-boundary="viewport" aria-haspopup="true" aria-expanded="false"><span class="fas fa-ellipsis-h fs-11"></span></button>
                  ...
                  <div class="row">
                    <div class="col-6 border-end border-200 py-3 d-flex justify-content-center">
                      <div>
                        ...
                        <h6 class="fs-9 mb-0 d-flex align-items-center">150<small class="badge px-0 text-success bg-transparent d-flex align-items-start"><span class="fas fa-caret-up ms-2 me-1 fs-11"></span><span class="fs-10">23.3%</span></small></h6>
                      </div>
                    </div>
                    <div class="col-6 py-3 d-flex justify-content-center">
                      <div>
                        <h6 class="text-600 mb-1 fs-11">Negative</h6>
                        <h6 class="fs-9 mb-0 d-flex align-items-center">20<small class="badge px-0 text-danger d-flex align-items-start"><span class="fas fa-caret-down ms-2 me-1 fs-11"></span><span class="fs-10">5.23%</span></small></h6>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="card-body ticket-todo-list scrollbar-overlay">
                  <div class="d-flex hover-actions-trigger btn-reveal-trigger gap-3 border-200 border-bottom mb-3">
                    <div class="form-check mb-0">
                      ...
                      <label class="form-check-label w-100 pe-3" for="ticket-checkbox-todo-0"><span class="mb-1 text-700 d-block">Sidenav text cutoff rendering issue</span><span class="fs-11 text-600 lh-base font-base fw-normal d-block mb-2">Problem with Falcon theme</span></label>
                    </div>
                    <div class="hover-actions end-0">
                      <button class="btn fs-11 icon-item-sm btn-link px-0 text-600"><span class="fas fa-trash text-danger"></span></button>
                    </div>
                  </div>
                  <div class="d-flex hover-actions-trigger btn-reveal-trigger gap-3 border-200 border-bottom mb-3">
                    <div class="form-check mb-0">
                      <input class="form-check-input form-check-line-through" type="checkbox" id="ticket-checkbox-todo-1" />
                      <label class="form-check-label w-100 pe-3" for="ticket-checkbox-todo-1"><span class="mb-1 text-700 d-block">Notify when the WebPack release is ready</span><span class="fs-11 text-600 lh-base font-base fw-normal d-block mb-2">Falcon Bootstarp 5</span></label>
                    </div>
                    <div class="hover-actions end-0">
                      <button class="btn fs-11 icon-item-sm btn-link px-0 text-600"><span class="fas fa-trash text-danger"></span></button>
                    </div>
                  ...
                  <div class="d-flex hover-actions-trigger btn-reveal-trigger gap-3 border-200 border-bottom mb-3">
                    <div class="form-check mb-0">
                      ...
                      <label class="form-check-label w-100 pe-3" for="ticket-checkbox-todo-3"><span class="mb-1 text-700 d-block">Billing a Client</span><span class="fs-11 text-600 lh-base font-base fw-normal d-block mb-2">It's also possible to create a billable item for a client when you reply to a ticket. You can generate invoices or log time spent on a ticket.</span></label>
                    </div>
                    <div class="hover-actions end-0">
                      <button class="btn fs-11 icon-item-sm btn-link px-0 text-600"><span class="fas fa-trash text-danger"></span></button>
                    </div>
                  ...
                  <div class="d-flex hover-actions-trigger btn-reveal-trigger gap-3 border-200 border-bottom mb-3">
                    <div class="form-check mb-0">
                      ...
                      <label class="form-check-label w-100 pe-3" for="ticket-checkbox-todo-4"><span class="mb-1 text-700 d-block">Sidenav text cutoff rendering issue</span><span class="fs-11 text-600 lh-base font-base fw-normal d-block mb-2">Problem with Falcon theme</span></label>
                    </div>
                    <div class="hover-actions end-0">
                      <button class="btn fs-11 icon-item-sm btn-link px-0 text-600"><span class="fas fa-trash text-danger"></span></button>
                    </div>
                  ...
                  <div class="d-flex hover-actions-trigger btn-reveal-trigger gap-3 border-200 border-bottom mb-3">
                    <div class="form-check mb-0">
                      ...
                      <label class="form-check-label w-100 pe-3" for="ticket-checkbox-todo-5"><span class="mb-1 text-700 d-block">Notify when the WebPack release is ready</span><span class="fs-11 text-600 lh-base font-base fw-normal d-block mb-2">Falcon Bootstarp 5</span></label>
                    </div>
                    <div class="hover-actions end-0">
                      <button class="btn fs-11 icon-item-sm btn-link px-0 text-600"><span class="fas fa-trash text-danger"></span></button>
                    </div>
                        ...
                        <table class="table table-sm mb-0 fs-10 table-view-tickets">
                          ...
                          <tbody class="list" id="table-ticket-body">
                            <tr>
                              ...
                              <td class="align-middle status fs-9 pe-4"><small class="badge rounded badge-subtle-success false">Recent</small>
                              </td>
                            ...
                            <tr>
                              ...
                              <td class="align-middle status fs-9 pe-4"><small class="badge rounded badge-subtle-danger false">Overdue</small>
                              </td>
                              <td class="align-middle priority pe-4">
                                <div class="d-flex align-items-center gap-2">
                            ...
                            <tr>
                              ...
                              <td class="align-middle status fs-9 pe-4"><small class="badge rounded badge-subtle-warning false">Remaining</small>
                              </td>
                              <td class="align-middle priority pe-4">
                                <div class="d-flex align-items-center gap-2">
                            ...
                            <tr>
                              ...
                              <td class="align-middle subject py-2 pe-4"><a class="fw-semi-bold" href="../app/support-desk/tickets-preview.html">I need your help #2256</a></td>
                              <td class="align-middle status fs-9 pe-4"><small class="badge rounded badge-subtle-info false">Responded</small>
                              </td>
                              <td class="align-middle priority pe-4">
                                <div class="d-flex align-items-center gap-2">
                            ...
                            <tr>
                              ...
                              <td class="align-middle client white-space-nowrap pe-3 pe-xxl-4 ps-2">
                                <div class="d-flex align-items-center gap-2 position-relative">
                                  <div class="avatar avatar-xl">
                                    <img class="rounded-circle" src="<?php echo BASE_URL; ?>/resources/assets/img/team/25-thumb.png" alt="" />
                              ...
                              <td class="align-middle status fs-9 pe-4"><small class="badge rounded badge-subtle-secondary dark__bg-1000">Closed</small>
                              </td>
                              <td class="align-middle priority pe-4">
                                <div class="d-flex align-items-center gap-2">
                                  <div style="--falcon-circle-progress-bar:50">
                            ...
                            <tr>
                              ...
                              <td class="align-middle client white-space-nowrap pe-3 pe-xxl-4 ps-2">
                                <div class="d-flex align-items-center gap-2 position-relative">
                                  <div class="avatar avatar-xl">
                                    <img class="rounded-circle" src="<?php echo BASE_URL; ?>/resources/assets/img/team/14-thumb.png" alt="" />
