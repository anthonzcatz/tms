                    ...
                    <div class="col-xxl-8">
                        ...
                        <div class="card">
                            <div class="bg-holder bg-card"
                                style="background-image:url(../../public/assets/img/icons/spot-illustrations/corner-5.png);">
                            </div>
                            <!--/.bg-holder-->

                            <div class="card-body position-relative">
                                <div class="row g-2 align-items-sm-center">
                                    <div class="col-auto"><img src="../../public/assets/img/icons/connect-circle.png"
                                            alt="" height="55" /></div>
                                    <div class="col">
                                    ...
                                    <table class="table table-sm mb-0">
                                        <tbody>
                                            <tr>
                                                <td class="py-3">
                                                    <div class="d-flex align-items-center"><img
                                                            src="../../public/assets/img/icons/chrome-logo.png" alt=""
                                                            width="16" />
                                            ...
                                            <tr>
                                                <td class="py-3">
                                                    <div class="d-flex align-items-center"><img
                                                            src="../../public/assets/img/icons/safari-logo.png" alt=""
                                                            width="16" />
                                            ...
                                            <tr>
                                                <td class="py-3">
                                                    <div class="d-flex align-items-center"><img
                                                            src="../../public/assets/img/icons/firefox-logo.png" alt=""
                                                            width="16" />
                        ...
                        <div class="card h-100">
                            <div class="card-header">
                                <div class="d-flex align-items-center"><img class="me-2"
                                        src="../../public/assets/img/icons/signal.png" alt="" height="35" />
                            ...
                            <div class="card-body p-0">
                                <div class="scrollbar-overlay pt-0 px-x1 ask-analytics">
                                    ...
                                    <div
                                        ...
                                        <h5 class="fs-10 text-800">What are my top default channel groupings by user?
                                        </h5>
                                    </div>
                                    <div
                                        class="border border-1 border-300 rounded-2 p-3 ask-analytics-item position-relative mb-3">
                                    ...
                                    <table class="table fs-10 mb-0 overflow-hidden">
                                        ...
                                        <tbody class="list">
                                            ...
                                            <tr class="btn-reveal-trigger">
                                                <td class="align-middle white-space-nowrap path"><a
                                                        class="text-primary fw-semi-bold"
                                                        href="#!">/themewagon.com/themes/free-website-template</a></td>
        ...
        <div class="offcanvas-body scrollbar-overlay px-x1 h-100" id="themeController">
                ...
                <div class="row gx-2">
                    <div class="col-4">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherLight"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="../../public/assets/img/generic/falcon-mode-default.jpg" alt="" /></span><span
                    ...
                    <div class="col-4">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherDark"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="../../public/assets/img/generic/falcon-mode-dark.jpg" alt="" /></span><span
                    ...
                    <div class="col-4">
                        ...
                        <label class="btn d-inline-block btn-navbar-style fs-10" for="themeSwitcherAuto"> <span
                                class="hover-overlay mb-2 rounded d-block"><img class="img-fluid img-prototype mb-0"
                                    src="../../public/assets/img/generic/falcon-mode-auto.jpg" alt="" /></span><span
            ...
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2"
                        src="../../public/assets/img/icons/left-arrow-from-left.svg" width="20" alt="" />
                    <div class="flex-1">
            ...
            <hr />
            <div class="d-flex justify-content-between">
                <div class="d-flex align-items-start"><img class="me-2" src="../../public/assets/img/icons/arrows-h.svg"
                        width="20" alt="" />
                    <div class="flex-1">
            ...
            <hr />
            <div class="d-flex align-items-start"><img class="me-2" src="../../public/assets/img/icons/paragraph.svg"
                    width="20" alt="" />
                <div class="flex-1">
                ...
                <div class="row gx-2">
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-transparent"> <img
                                class="img-fluid img-prototype" src="../../public/assets/img/generic/default.png"
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-inverted"> <img
                                class="img-fluid img-prototype" src="../../public/assets/img/generic/inverted.png"
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-card"> <img
                                class="img-fluid img-prototype" src="../../public/assets/img/generic/card.png"
                    ...
                    <div class="col-6">
                        ...
                        <label class="btn d-block w-100 btn-navbar-style fs-10" for="navbar-style-vibrant"> <img
                                class="img-fluid img-prototype" src="../../public/assets/img/generic/vibrant.png"
                                alt="" /><span class="label-text"> Vibrant</span></label>
                    </div>
                </div>
            </div>
            <div class="text-center mt-5"><img class="mb-4"
                    src="../../public/assets/img/icons/spot-illustrations/47.png" alt="" width="120" />
