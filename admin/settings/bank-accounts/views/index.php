  ...
  <main class="main" id="top">
    <div class="container" data-layout="container">
      <script>
                ...
                <div class="row flex-between-center gx-0">
                  ...
                  <div class="col-lg-auto">
                    <button class="btn btn-primary" onclick="openAddAccountModal()">
                      <span class="fas fa-plus"></span><span class="ms-2 d-none d-sm-inline">Add Bank Account</span>
                    </button>
                  </div>
                </div>
              </div>
        ...
        <?php $activeWalletModule = 'bank-accounts'; include dirname(dirname(dirname(__DIR__))) . '/wallet/_partials/wallet_nav.php'; ?>
