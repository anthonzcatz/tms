              ...
              <div class="card-body p-0">
                <div class="table-responsive">
                  <table class="table table-hover mb-0">
                    <thead class="bg-light"><tr><th>Position Name</th><th>Code</th><th>Added By</th><th>Date Added</th><th class="text-end">Actions</th></tr></thead>
                    <tbody id="positionsTableBody">
                      <?php foreach ($positions as $pos): ?>
                      <tr data-pos-id="<?php echo $pos['pos_id']; ?>" data-name="<?php echo htmlspecialchars(strtolower($pos['position_name'])); ?>">
                        ...
                        <td class="text-end">
                          ...
                          <button class="btn btn-sm btn-outline-danger" onclick="deletePosition(<?php echo $pos['pos_id']; ?>, '<?php echo htmlspecialchars($pos['position_name'], ENT_QUOTES); ?>')"><span class="fas fa-trash"></span></button>
                        </td>
                      </tr>
                      <?php endforeach; ?>
                    </tbody>
