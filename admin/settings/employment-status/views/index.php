...
<link rel="stylesheet" href="<?php echo BASE_URL; ?>/admin/settings/employment-status/assets/css/employment-status.css?v=<?php echo filemtime(dirname(__DIR__) . '/assets/css/employment-status.css'); ?>">
<body>
    ...
    <div class="container" data-layout="container">
      ...
      <?php endif; ?>
              ...
              <div class="card-header z-1">
                <div class="row flex-between-center gx-0">
                  <div class="col-lg-auto d-flex align-items-center">
                    ...
                    <div class="ms-x1">
                      <h4 class="mb-0 text-primary fw-bold">Employment Status <span class="text-info fw-medium">Management</span></h4>
                  ...
                  <div class="col-lg-auto d-flex align-items-center mt-3 mt-lg-0">
                    <button class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addEmploymentStatusModal"><span class="fas fa-plus"></span><span class="ms-2 d-none d-sm-inline">Add Status</span></button>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="row g-3 mb-3">
          <div class="col-sm-6 col-md-3">
            <div class="card h-md-100">
              <div class="card-header pb-0"><h6 class="mb-0 mt-2">Total Statuses</h6></div>
              <div class="card-body d-flex flex-column justify-content-end">
                <div class="row">
                  <div class="col"><p class="font-sans-serif lh-1 mb-1 fs-5" id="totalStatuses"><?php echo count($employmentStatuses); ?></p></div>
                  <div class="col-auto ps-0"><span class="fas fa-user-check text-primary fs-4"></span></div>
                </div>
              </div>
            </div>
          </div>
                ...
                <div class="row g-3 align-items-end">
                  <div class="col-md-4">
                    <div class="search-box">
                      <input type="text" class="form-control search-input" id="statusSearch" placeholder="Search employment statuses...">
        ...
        <div class="row g-3">
          <div class="col-12">
            <div class="card">
              <div class="card-header"><h6 class="mb-0">Employment Status List</h6></div>
              <div class="card-body p-0">
                ...
                <div id="emptyState" class="text-center py-5 d-none"><p class="text-muted">No employment statuses found</p></div>
              </div>
            </div>
          </div>
        </div>
  ...
  <?php include __DIR__ . '/modals/add_employment_status.php'; ?>
  <?php include __DIR__ . '/modals/edit_employment_status.php'; ?>
  <?php include __DIR__ . '/modals/delete_employment_status.php'; ?>
  ...
  <script src="<?php echo BASE_URL; ?>/admin/settings/employment-status/assets/js/employment-status.js?v=<?php echo filemtime(dirname(__DIR__) . '/assets/js/employment-status.js'); ?>"></script>
