                  ...
                  <div class="col-md-7 d-flex flex-center">
                    <div class="p-4 p-md-5 flex-grow-1">
                      <div class="text-center"><img class="d-block mx-auto mb-4" src="resources/assets/img/icons/spot-illustrations/16.png" alt="Email" width="100" />
                        ...
                        <p>An email has been sent to <strong>xyz@abc.com</strong>. Please click on the <br class="d-none d-sm-block d-md-none" />included link to reset <span class="white-space-nowrap">your password.</span>
